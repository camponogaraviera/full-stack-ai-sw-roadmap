...
- [Model-View-Controller (MVC)](full_stack/patterns/mvc.md)
- [Model-View-Presenter (MVP)](full_stack/patterns/mvp.md)
- [Model-View-ViewModel (MVVM)](full_stack/patterns/mvvm.md)

### 3.1.3 Application/System Architectural Patterns

- [Layered Architecture](full_stack/patterns/layered.md)
- [Hexagonal Architecture](full_stack/patterns/hexagonal.md)
- [Onion Architecture](full_stack/patterns/onion.md)
- [Clean Architecture](full_stack/patterns/clean.md)
...
- [Multi-page Applications (MPA)](full_stack/frontend/architectures/mpa.md)
- [Single-Page Application (SPA)](full_stack/frontend/architectures/spa.md)

### 3.2.2 Rendering Strategies

- [Client-Side Rendering (CSR)](full_stack/frontend/render/csr.md)
- [Server-Side Rendering (SSR)](full_stack/frontend/render/ssr.md)
- [Static Site Generation (SSG)](full_stack/frontend/render/ssg.md)
...
- Database Models
  - [Relational Databases](full_stack/backend/database/core/relational_db.md)
  - [Non-Relational (NoSQL) Databases](full_stack/backend/database/core/non_relational_db.md)
  - [Vector Databases](full_stack/backend/database/core/vector_db.md)

- Data Modeling & Schema Design
  - [Data Normalization vs Denormalization](full_stack/backend/database/core/norm_denorm.md)
...
- [RESTful APIs](full_stack/backend/api/restfull_api.md)
- [ORM & ODM](full_stack/backend/api/orm_odm.md)
- [CORS](full_stack/backend/api/cors.md)
- [Authentication: JSON Web Tokens and Refresh Tokens](full_stack/backend/api/jwt_and_refresh_tokens.md)
- [GraphQL APIs](full_stack/backend/api/graphql.md)
  - [Apollo](full_stack/backend/api/apollo.md)

- [Real-Time Communication: Polling vs. WebSockets](full_stack/backend/api/web_sockets.md)
- [gRPC APIs](full_stack/backend/api/gRPC.md)
- [WebRTC](full_stack/backend/api/webrtc.md)

### 3.3.4 System Architectural Styles & Patterns

- Codebase/Deployment Architecture Styles:
  - [Monolithic vs Microservices](full_stack/backend/architecture/mono_vs_micro.md)

- API Design Patterns:
  - [Backend for Frontend (BFF)](full_stack/backend/patterns/bff.md)
  - [API Composition Pattern](full_stack/backend/patterns/api_cp.md)

- [Data-Management Patterns for Distributed Systems](full_stack/backend/patterns/data_patterns.md)
  - Saga Pattern
...
---
  ...
  <details>
    <summary><h2 id="system_design">3.5 System Design</h2></summary>

### 3.5.1 [URL/DNS/SSL](full_stack/system_design/url_dns.md)
...
### 3.5.2 [Servers](full_stack/system_design/servers.md)
...
### 3.5.3 [Over-Provisioning for Resiliency](full_stack/system_design/over_provisioning.md)
...
<!-- #region 5. System Design Interviews with AWS -->
<details>
  <summary><h1 id="interviews">5. Mock System Design Interviews with AWS </h1></summary>

- [Design a Restaurant Reservation System](interview_prep/rest_reservation.md)
- [Design a YouTube-like On-Demand Video Streaming Service](interview_prep/youtube.md)
- [Design a Search Engine like Google](interview_prep/google_search_engine.md)
