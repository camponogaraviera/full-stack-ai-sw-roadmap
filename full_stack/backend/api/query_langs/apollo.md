...
Apollo Server is a JavaScript/TypeScript GraphQL server-side library for building scalable and production-ready GraphQL servers in Node.js. It supports schema stitching, real-time subscriptions, custom directives, and Node.js middleware.
...
[1] https://master--apollo-docs-index.netlify.app/docs/intro/platform/
