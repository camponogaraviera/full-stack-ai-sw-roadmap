...
GraphQL is a schema-based `API query language and runtime (execution model)` that enables clients to request exactly the data they need from a server in a single request.
